...
alter table employee add foreign key(Dno) references department(Dnumber) on delete set
NULL;
alter table employee add foreign key(Super_ssn) references employee(ssn) on delete set
NULL;
